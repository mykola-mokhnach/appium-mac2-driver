...
// A TCP listener/connection wrapper backed by Network.framework rather than BSD sockets.
@protocol AMTCPSocketDelegate <NSObject>
...
@interface AMTCPSocket : NSObject

@property (nullable, nonatomic, weak) id<AMTCPSocketDelegate> delegate;
